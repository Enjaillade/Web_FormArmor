 ...
 */
class Confirmation_inscriptionRepository extends \Doctrine\ORM\EntityRepository
{
  public function listeConfirmation($page, $nbParPage, $id)
	{
	...
	public function suppConfirmation($id) // Suppression du statut d'identifiant $id
	{
		$qb = $this->createQueryBuilder('s');
		$query = $qb->delete('FormArmorBundle\Entity\Confirmation_inscription', 's')
		  ->where('s.id = :id')
		  ->setParameter('id', $id);
